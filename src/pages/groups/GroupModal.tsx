...
function GroupModal({open , setOpen }) {
  ...
  const sendGroup = async (values:any)=>{
    try{
        console.log(values);
        const data = {...values, color: values.color.toHexString()}
        console.log(data)
                                        ...
                                        <div className="modal-body">
                                            <div className="row">                                                            
                                                <div className="col-md-12">
                                                    <div className="mb-3">
                                                        <label className="form-label" htmlFor="formrow-firstname-input"> الفئة </label>
                                                ...
                                                <div className="col-md-12">
                                                    <label className="form-label" htmlFor="formrow-password-input"> اللون  </label>
